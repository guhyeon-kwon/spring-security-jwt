...
import static com.study.jwt.utils.CommonUtil.getUsernameFromToken;
...
public class EmailController {
    ...
    public ResponseEntity<ReturnObject> certifyUser(HttpServletRequest request, Errors errors){
