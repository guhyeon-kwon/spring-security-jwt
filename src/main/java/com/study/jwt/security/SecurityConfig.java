...
import com.study.jwt.filter.CustomAuthenticationFilter;
import com.study.jwt.filter.CustomAuthorizationFilter;
import com.study.jwt.service.UserDetailServiceImpl;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/api/login/**", "/api/token/refresh/**", "/api/user", "/sms/certify-regis", "/sms/list", "/api/check-sms-code").permitAll();
